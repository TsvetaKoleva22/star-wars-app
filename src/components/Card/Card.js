...
import { fetchHomeworld } from '../../utils/fetchUtils';
...
const Card = ({
    ...
    const homeworldUrl = item?.homeworld_url;
    ...
    return (
        ...
        >
            <div className="card__header">
                ...
                {item.type === 'character' && <h5 className={`card__subtitle card__subtitle--${item.type}`}>{data ? data : 'Loading...'}</h5>}
